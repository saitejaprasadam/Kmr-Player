...
public class SharedPreferenceKeyConstants {
    ...
    public static final String KEY_FLOATING_NOTIFICATIONS = "KEY_FLOATING_NOTIFICATIONS";

    public static final String KEY_BLUR_ALBUM_ART = "KEY_BLUR_ALBUM_ART";
    public static final String KEY_ALBUM_ART = "KEY_ALBUM_ART";
    ...
    public static final String KEY_REPORT_BUG = "KEY_REPORT_BUG";
}