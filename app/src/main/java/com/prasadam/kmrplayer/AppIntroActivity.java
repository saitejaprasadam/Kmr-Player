...
public class AppIntroActivity extends AppIntro2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(AppIntro2Fragment.newInstance(getString(R.string.app_name), getString(R.string.app_description_text), R.mipmap.launcher_icon_big, getResources().getColor(R.color.temp)));
