...
public class CustomPlaylistSongsRecylcerViewAdapter extends RecyclerView.Adapter<CustomPlaylistSongsRecylcerViewAdapter.songsViewHolder>{
    ...
    public void onBindViewHolder(final songsViewHolder holder, final int position) {
        try
        {
            final Song currentSongDetails = customPlaylistSongsList.get(position);
            ...
            holder.rootLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mediaController.music.musicService.setList(customPlaylistSongsList);
                    mediaController.music.musicService.setSong(AudioExtensionMethods.getSongIndex(customPlaylistSongsList, view.getTag().toString()));
                    try
                    {
                                                    ...
                                                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                                                        ...
                                                        public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                                            ...
                                                            if(file.delete())
                                                            {
                                                                ...
                                                                customPlaylistSongsList =  AudioExtensionMethods.getSongList(context);
    ...
    public int getItemCount() {
        return customPlaylistSongsList.size();
    }
